...
if ($name == "") {
    ...
    $headers .= 'From:  Papr <simony.koffi@gmail.com>' . "\r\n";
    $headers .= 'cc: simony.koffi@gmail.com' . "\r\n";
    $headers .= 'bcc: simony.koffi@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f simony.koffi@gmail.com');
